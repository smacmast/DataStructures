...
public class MyLinkedListTest {
	...
	public void testListIterator(){
		...
		assertFalse(l.hasNext());
		assertTrue(l.hasPrevious());
		assertEquals((Integer) 3, l.previous());
		
		assertTrue(l.hasNext());
		assertTrue(l.hasPrevious());
		assertEquals((Integer) 2, l.previous());
		
		assertTrue(l.hasNext());
		assertFalse(l.hasPrevious());
		assertEquals((Integer) 1, l.previous());
	...
	public void testListIteratorException1(){
		MyLinkedList<String> m = new MyLinkedList<String>();
		m.add("String1"); m.add("String2"); m.add("String3");
		ListIterator<String> l = m.listIterator(3);
		l.hasNext();
	}
	...
	public void testListIteratorException2(){
		MyLinkedList<String> m = new MyLinkedList<String>();
		m.add("String1"); m.add("String2"); m.add("String3");
		ListIterator<String> l = m.listIterator();
		l.remove(); l.remove();
		l.next();
	}
