...
public class MyQueueTest {
	...
	public void testPushPeekPop() {
		...
		m.push(1); assertEquals((Integer) 0, m.peek());
		...
		m.push(3); assertEquals((Integer) 2, m.peek());
		m.push(4); assertEquals((Integer) 2, m.peek());
		m.push(5); assertEquals((Integer) 2, m.peek());
